const element = (
    <div class='main' title="outer div">
        ...
        <form action="https://github.com/rgupta2063?tab=repositories/" method="get" target="_blank">
            <button class='button' type="submit">VIEW MY GITHUB REPO</button>
        </form>
    </div>);
